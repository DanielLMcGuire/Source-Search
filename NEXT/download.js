...
function startLinuxDownload(version) {
    ...
    switch (version) {
        case 'deb':
            downloadUrl = '../dl404.html'; // Replace with actual Debian/Ubuntu URL
            break;
        case 'pkg':
            downloadUrl = '../dl404.html'; // Replace with actual Arch/Manjaro URL
            break;
        case 'appimage':
            downloadUrl = '../dl404.html'; // Replace with actual AppImage URL
            break;
        default:
            downloadUrl = '../dl404.html'; // Default or error URL
            break;
    }
    showCountdownPopup(() => {
...
function downloadWindows() {
    showCountdownPopup(() => {
        window.location.href = "../dl404.html"; // Replace with your actual Windows download URL
    });
}
...
function sourceCode() {
    window.location.href = "../dl404.html"; // Replace with your actual source code URL
}
