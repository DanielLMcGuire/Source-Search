...
function startLinuxDownload(version) {
    ...
    switch (version) {
        case 'deb':
            downloadUrl = 'https://github.com/DanielLMcGuire/Source-Search/releases/download/1.0.0/sourcesearch_1.0.0.deb';
            break;
        case 'pkg':
            downloadUrl = 'https://github.com/DanielLMcGuire/Source-Search/releases/download/1.0.0/sourcesearch-1.0.0-x86_64.AppImage';
            break;
        case 'appimage':
            downloadUrl = 'https://github.com/DanielLMcGuire/Source-Search/releases/download/1.2.5/sourcesearch-x86_64-1.2.5.AppImage'; // Replace with actual AppImage URL
            break;
        default:
...
function downloadWindows() {
    showCountdownPopup(() => {
        window.location.href = "https://github.com/DanielLMcGuire/Source-Search/releases/download/1.0.0/sourcesearch_installer1.0.0.exe"; // Replace with your actual Windows download URL
    });
}
...
function sourceCode() {
    window.location.href = "https://github.com/DanielLMcGuire/Source-Search/archive/refs/tags/1.0.0.zip"; // Replace with your actual source code URL
}
